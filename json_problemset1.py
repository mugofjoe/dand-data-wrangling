...
API_KEY = {"popular": "62b384148b5d449ebba809429f56e88b",
           "article": "62b384148b5d449ebba809429f56e88b"}
...
def article_overview(kind, period):
    """
    To solve this exercise you should look at the example file 
    and see what is the data structure. Once you do that, 
    extracting the required values is not that complicated:
    """
    # YOUR CODE HERE
...
def save_file(kind, period):
    ...
    data = get_popular(URL_POPULAR, "viewed", period)
...
def test():
    ...
    # Retrieves data from an API stream
    # data = get_popular(URL_POPULAR, "viewed", 7)

    # Dumps the results of the stream into a file
    # save_file("viewed", 7)
...
#     # YOUR CODE HERE
#     data = get_from_file(kind, period)
#     titles = [{item['section']:item['title']} for item in data]
#     urls = [format_item['url'] for data_item in data
#             for media_item in data_item['media']
#             for format_item in media_item['media-metadata']
#             if format_item['format'] == 'Standard Thumbnail']
#     return (titles, urls)
